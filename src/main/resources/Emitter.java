...
public class Emitter implements EmitterWrapper {
    ...
    private static Set<String> ignoreCacheValues = new HashSet<>();
     ...
     */
    public static void setMaxRecords(int pRecord) {
        record = pRecord;
    }
    ...
    private boolean containsInvalidCacheContent(String documentText) {
        for (String ignoreCacheValue : ignoreCacheValues) {
            if (documentText.contains(ignoreCacheValue)) {
                return true;
            }
        }
        return false;
    ...
    private int[] waitTimes = new int[]{2, 10, 60};
    ...
    private void sleepSeconds(int sleepSeconds) {
        try {
     ...
     */
    public static void addCacheIgnoreText(String pValue) {
        ignoreCacheValues.add(pValue);
    }
